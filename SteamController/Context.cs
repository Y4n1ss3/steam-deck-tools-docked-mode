        ...
        private void ExternalGamepadPassthrough()
        {
            ...
            try
            {
                foreach (var raw in Windows.Gaming.Input.RawGameController.RawGameControllers)
                {
                    ...
                    // --- Buttons ---
                    if (buttons.Length > 0) X360[Nefarius.ViGEm.Client.Targets.Xbox360.Xbox360Button.A] = buttons[0];
                    if (buttons.Length > 1) X360[Nefarius.ViGEm.Client.Targets.Xbox360.Xbox360Button.B] = buttons[1];
                    if (buttons.Length > 2) X360[Nefarius.ViGEm.Client.Targets.Xbox360.Xbox360Button.X] = buttons[2];
                    if (buttons.Length > 3) X360[Nefarius.ViGEm.Client.Targets.Xbox360.Xbox360Button.Y] = buttons[3];
                    if (buttons.Length > 4) X360[Nefarius.ViGEm.Client.Targets.Xbox360.Xbox360Button.LeftShoulder] = buttons[4];
                    if (buttons.Length > 5) X360[Nefarius.ViGEm.Client.Targets.Xbox360.Xbox360Button.RightShoulder] = buttons[5];
                    if (buttons.Length > 6) X360[Nefarius.ViGEm.Client.Targets.Xbox360.Xbox360Button.Back] = buttons[6];
                    if (buttons.Length > 7) X360[Nefarius.ViGEm.Client.Targets.Xbox360.Xbox360Button.Start] = buttons[7];
                    if (buttons.Length > 8) X360[Nefarius.ViGEm.Client.Targets.Xbox360.Xbox360Button.LeftThumb] = buttons[8];
                    if (buttons.Length > 9) X360[Nefarius.ViGEm.Client.Targets.Xbox360.Xbox360Button.RightThumb] = buttons[9];

                    // --- D-pad via switch ---
                    if (switches.Length > 0)
                    {
                        var d = switches[0];
                        X360[Nefarius.ViGEm.Client.Targets.Xbox360.Xbox360Button.Up] =
                        ...
                        X360[Nefarius.ViGEm.Client.Targets.Xbox360.Xbox360Button.Down] =
                        ...
                        X360[Nefarius.ViGEm.Client.Targets.Xbox360.Xbox360Button.Left] =
                            d == Windows.Gaming.Input.GameControllerSwitchPosition.Left ||
                            d == Windows.Gaming.Input.GameControllerSwitchPosition.UpLeft ||
                            d == Windows.Gaming.Input.GameControllerSwitchPosition.DownLeft;
                        X360[Nefarius.ViGEm.Client.Targets.Xbox360.Xbox360Button.Right] =
                    ...
                    if (axes.Length > 0) X360[Nefarius.ViGEm.Client.Targets.Xbox360.Xbox360Axis.LeftThumbX] = ToAxis(axes[0]);
                    if (axes.Length > 1) X360[Nefarius.ViGEm.Client.Targets.Xbox360.Xbox360Axis.LeftThumbY] = ToAxisInv(axes[1]);
                    if (axes.Length > 2) X360[Nefarius.ViGEm.Client.Targets.Xbox360.Xbox360Axis.RightThumbX] = ToAxis(axes[2]);
                    if (axes.Length > 3) X360[Nefarius.ViGEm.Client.Targets.Xbox360.Xbox360Axis.RightThumbY] = ToAxisInv(axes[3]);
                    if (axes.Length > 4) X360[Nefarius.ViGEm.Client.Targets.Xbox360.Xbox360Slider.LeftTrigger] = ToTrigger(axes[4]);
                    if (axes.Length > 5) X360[Nefarius.ViGEm.Client.Targets.Xbox360.Xbox360Slider.RightTrigger] = ToTrigger(axes[5]);

                    // Use only the FIRST external controller
                    break;
                }
            }
            catch (Exception ex)
